...
%><%
    ...
    String dateFrom = request.getParameter(Constants.DOMAIN_QUERY_DATEFROM_PARAM);
    String dateTo = request.getParameter(Constants.DOMAIN_QUERY_DATETO_PARAM);
    ...
    if (searchQuery != null && searchQuery.trim().length() > 0) {
        ...
        //Gson gson=new Gson();
        ResponseWrapper res = DomainDefinition.getDomains(pageContext, I18N, searchQuery, searchType, dateFrom, dateTo);
...
<fmt:message key="status.results.displayed">
    <fmt:param><%=totalResultsCount%>
    </fmt:param>
    <fmt:param><%=startIndex + 1%>
    </fmt:param>
    <fmt:param><%=endIndex%>
    </fmt:param>
</fmt:message>
